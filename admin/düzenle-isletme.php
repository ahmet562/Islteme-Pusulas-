        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 col-xs-12 padding-right-30">
                <div class="dashboard-list-box">
                    <h4 class="gray">İşletme Düzenle</h4>
                    <div class="dashboard-list-box-static">
                        ...
                        if (isset($_POST['ekle'])) {
                            ...
                            echo "<script>alert('Blog başarıyla güncellendi.'); window.location='isletme-düzenle.php';</script>";
                            exit;
                        }
                        ?>
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <textarea name="icerik2" cols="30" required rows="5"><?= $user[6] ?></textarea>
                            <label>Etiket</label>
            ...
            <div class="col-lg-6 col-md-6 col-xs-12">
                <div class="dashboard-list-box">
                    <h4 class="gray">İşletme ve Yönetici Diğer Bilgiler</h4>
                    <div class="dashboard-list-box-static">
                        <?php if (!empty($ikonPath) && file_exists($ikonPath)): ?>
                            <div class="edit-profile-photo">
                                <img src="<?= $ikonPath ?>" alt="Mevcut Resim" style="max-width: 150px; border: 1px solid #ccc; margin-bottom: 10px;">
                            </div>
                        <?php endif; ?>
